...
The deposit data file is a JSON file that contains a list of deposits that is mostly used for the [Ethereum Staking Launchpad](https://github.com/ethereum/staking-launchpad). It is loosely based on [the DepositData structure](https://github.com/ethereum/consensus-specs/blob/master/specs/phase0/beacon-chain.md#depositdata) and the [deposit function](https://github.com/ethereum/consensus-specs/blob/master/specs/phase0/deposit-contract.md#deposit-function) from the [deposit smart contract](https://github.com/ethereum/consensus-specs/blob/master/specs/phase0/deposit-contract.md)
...
- **withdrawal_credentials**: The withdrawal credentials value to be passed to the deposit function call. Contains a version (`02` or `01`), 0-padding, and the withdrawal address.
- **amount**: The deposit amount to be sent with the call to the deposit function call. The unit for this value is GWEI. Depositing at least 32 ETH in total (in GWEI, `32000000000`) allows a validator to be activated. The unit for this value is GWEI. This value can be an integer value higher or equal than 1 ETH and lower than or equal to 2048 ETH. Legacy Type 1 (0x01) validators will send anything above 32 ETH back to the withdrawal address.
...
[
  {
    ...
    "withdrawal_credentials":"02000000000000000000000000000000219ab540356cBB839Cbe05303d7705Fa",
    "amount":64000000000,
  ...
  },
  {
    ...
    "withdrawal_credentials":"01000000000000000000000000000000219ab540356cBB839Cbe05303d7705Fa",
    "amount":32000000000,
